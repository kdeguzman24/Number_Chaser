...
class SubHard: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.sub_hard)
    ...
    private fun startGame() {
        ...
        if (currentRound > 0) {
            ...
            val initialNumber = 60                                                  // first num na mag a-appear
            ...
            Handler().postDelayed({
                ...
                for (i in 1..3) {                                           // meaning 5 random number sa sequence
                    var nextNumber: Int
                    do {
                        nextNumber = Random.nextInt(5, 11)               // range nung sequence number
