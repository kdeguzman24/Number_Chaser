...
class SubNormal: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.sub_normal)
    ...
    private fun startGame() {
        ...
        if (currentRound > 0) {
            ...
            val initialNumber = 40                                                  // first num na mag a-appear
            ...
            Handler().postDelayed({
                ...
                for (i in 1..3) {                                           // meaning 5 random number sa sequence
                    var nextNumber: Int
                    do {
                        nextNumber = Random.nextInt(2, 8)               // range nung sequence number
    ...
    private fun displayNextNumber() {
        if (currentIndex < sequence.size) {
            ...
            Handler().postDelayed({
                currentIndex++
                displayNextNumber()
            }, 2000)                                       // eto yung deley sa pag-appear nung mga numbers
        } else {
